...
function SignUp() {
  ...
  return (
    ...
    <div className='container col-xxl-3 col-xl-3 col-lg-4 col-md-6 col-sm-8 col-10 align-items-center mt-5 py-4 bg-body-tertiary border rounded'>
        ...
        <form className='p-5 m-3 pb-3'>
            ...
            <label class="form-check-label" for="flexCheckDefault">
               I agree with the <a className='primary'>Terms and conditions</a> 
            </label>
            </div>
            <button
              ...
              type="submit" 
              control-id="ControlID-4">Sign Up
            </button>
            </form>
        </div>
        <div className='px-5'>
        <div className="separator pb-3 mb-3 px-3"><h5 className=" fw-normal text-secondary">Or</h5></div>
        <GoogleLogin 
          disabled={false}             
